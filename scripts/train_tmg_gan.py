...
if __name__ == '__main__':
    ...
    #     ]
    # )
    #print(lens, samples.shape, labels.shape)
    ...
    #datasets.tr_samples = datasets.tr_samples
    #datasets.te_samples = datasets.te_samples

    # make data here
    print("data", datasets.tr_samples.data[0], "\n")
    print("label", datasets.tr_samples.label[0], "\n")


    utils.set_dataset_values()
    print("feature nums: ", datasets.feature_num)
